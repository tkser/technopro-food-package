...
def train_cv(batch_size = 16, learning_rate = 1e-05, num_epochs = 16, seed = 42, lr_min = 1e-06, model_name = "convnextv2_huge", n_splits = 5, pretrained = True, use_flozen = True, start_fold = 0):
    ...
    model_save_path = os.path.join(os.path.dirname(__file__), '../../data/models/ConvNextV2_cv')
